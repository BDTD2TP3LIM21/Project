...
INSERT INTO DOCUMENTS(ID_DOCUMENTS, TITLE, THEME, SHELF, EDITOR_NAME, BORROW_ID)
    VALUES (0,'LE SILENCE DE LA MER', 'Biographie' , 132, 'Expand Drama', null);
    
INSERT INTO DOCUMENTS(ID_DOCUMENTS, TITLE, THEME, SHELF, EDITOR_NAME, BORROW_ID)
    VALUES (0,'CLARA ET MOI','Commentaire audio' , 140, 'Gloria films' , null);
    
INSERT INTO DOCUMENTS(ID_DOCUMENTS, TITLE, THEME, SHELF, EDITOR_NAME, BORROW_ID)
    VALUES (0,'SIA, LE RÊVE DU PYTHON' ,'Histoire afrique', 185, 'Les productions de la Lanterne', null);
    
INSERT INTO DOCUMENTS(ID_DOCUMENTS, TITLE, THEME, SHELF, EDITOR_NAME, BORROW_ID)
    VALUES (0,'IL ÉTAIT UNE FOIS UN FLIC' ,'Film Policier' , 196, 'Gaumont', null);
    
INSERT INTO DOCUMENTS(ID_DOCUMENTS, TITLE, THEME, SHELF, EDITOR_NAME, BORROW_ID)
    VALUES (0,'PETER PAN' , 'Fiction Fantastique', 530, 'Columbia pictures', null);
